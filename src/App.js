...
export default function App() {
  ...
  function emojiInputHandler(event) {
    ...
    if (meaning === undefined) {
      meaning = "This emoji is currently not defined in out database. ";
    }
    setMeaning(meaning);
  }
  ...
  return (
    <div className="App">
      ...
      <input
        placeholder="Put one emoji here"
        className="input"
        onChange={emojiInputHandler}
      />
      <h2 className="heading">Emoji interpretation here</h2>
